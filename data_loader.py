...
def get_loader(
    ...
    assert mode in [
        ...
        "val",
        "test",
    ], "mode must be one of 'train' or 'val' or 'test'."
    ...
    if mode == "train":
        ...
        annotations_file = os.path.join(
            cocoapi_loc, "cocoapi/annotations/captions_test2014.json"
        )
...
class CoCoDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        org_image = Image.open(os.path.join(self.img_folder, path)).convert("RGB")
